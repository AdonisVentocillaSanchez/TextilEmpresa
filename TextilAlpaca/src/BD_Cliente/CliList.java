...
import static BD_Productos.ProdModify.jTable_productos;
 ...
 * @author Sergio
 */
public class CliList extends javax.swing.JDialog {

    /**
     * Creates new form CliList
     */
    Control_Cliente cc = new Control_Cliente();
    
    public CliList(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            MessageFormat footerFormat = new MessageFormat("TEXTIL CONDOR");
            //Imprimir JTable
            jTableListarCliente.print(JTable.PrintMode.FIT_WIDTH, headerFormat, footerFormat);
        } catch (PrinterException ex) {
            Logger.getLogger(CliList.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CliList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CliList dialog = new CliList(new javax.swing.JFrame(), true);
