 ...
 * @author Sergio
 */
public class CliDelete extends javax.swing.JDialog {
String idcliente;
    /**
    ...
    public CliDelete(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CliDelete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CliDelete dialog = new CliDelete(new javax.swing.JFrame(), true);
